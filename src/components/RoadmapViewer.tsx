...
export const RoadmapViewer: React.FC<RoadmapViewerProps> = ({ data, progressData }) => {
  const { roadmap } = data;
  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4 relative flex">
      <div className="flex-grow">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-extrabold text-slate-900 mb-4">{roadmap.title}</h1>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto mb-8">{roadmap.description}</p>
